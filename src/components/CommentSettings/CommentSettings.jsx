...
export default function CommentSettings({ onDelete, onEdit }) {
    ...
    <Dropdown>
      <DropdownTrigger>
        <button className="hover:bg-gray-200 dark:hover:bg-gray-700 rounded-full p-1 transition-colors">
          <Ellipsis size={14} className="text-default-400" />
        </button>
      </DropdownTrigger>
      <DropdownMenu aria-label="Comment actions" variant="faded">
        <DropdownItem
          key="edit"
